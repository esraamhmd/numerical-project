...
def calculate_root():
    ...
    results = []
    fixed_point_iteration(x, 0, 0, results)

# Create tkinter window
root = tk.Tk()
root.title("Fixed-Point  Method Calculator")
...
title_label = tk.Label(root, text="Fixed-Point  Method", font=("Helvetica", 20, "bold"), fg="#00224D", bg="#FF3EA5")
...
tk.Label(input_frame, text="Enter g(x):", bg="#00224D", fg="#FFFFFF", font=("Helvetica", 12, "bold")).grid(row=0, column=0, sticky="w")
entry_g = tk.Entry(input_frame, font=("Helvetica", 12, "bold"))
entry_g.grid(row=0, column=1, padx=10, pady=5)
...
columns = ("Iteration", "xi", "f(xi)", "Error %")
