...
def bisect(xl, xu, xr, xr_old, error, iter, results):
    ...
    if error > eps:
        bisect(xl, xu, xr, xr_old, error, iter, results)
    else:
...
title_label = tk.Label(root, text="Bisection Method", font=("Helvetica", 20, "bold"), fg="#00224D", bg="#FF3EA5")
